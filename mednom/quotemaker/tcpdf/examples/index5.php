...
$strOutput .='<tr>
      <td width="50%" valign="top"><div style="padding:10px;"> <strong>'. $row_pd1['product_name'].'</strong><br><table><tr><td style="padding:10px;">'.nl2br($product_desc3).'</td></tr></table></div></td>
      <td width="20%" valign="top"><p align="right">'.number_format($sp, 2, '.', ',').'  </p></td>
      <td width="10%" valign="top"><p align="center">'.$row_pd1['product_quantity']. '  </p></td>
      <td width="20%" valign="top"><p align="right">'.number_format($totsp, 2, '.', ','). '  </p></td>
    </tr>';	
}
}
...
$html = '<div style="font-size:17px;"><hr><div align="center"><strong>Proforma Invoice</strong><hr></div></div><br><table><tr><td><p><strong> To,<br>'.ucwords($row_contacts['cont_sal']).' '.ucwords($row_contacts['cont_firstname']).' '.ucwords($row_contacts['cont_lastname']).'</strong><br />
...
<div style="clear:both"></div><table border="1" cellspacing="0" cellpadding="2" width="100%"><tr>
  ...
  </table><br><br><table border="1" width="100%" cellpadding="10"><tr><td width="70%"><p><strong><em> Terms and Conditions</em></strong><br></p>'.$row_qt1['qt_tnc'].'</td><td width="30%"><br><br><br><img src="images/Labocon-Stamp-and-Signatutre.png"  width="113" height="85"></td></tr></table>';
