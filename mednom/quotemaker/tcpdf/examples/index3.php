...
$html = '<div align="center" style="font-size:17px;"><strong>Quotations</strong></div><table><tr><td><p><strong>'.ucwords($row_contacts['cont_sal']).' '.ucwords($row_contacts['cont_firstname']).' '.ucwords($row_contacts['cont_lastname']).'</strong><br />
  '.$strOrg.'</p></td><td align="right"><p><strong>Ref  No :- '.$ref_no.' </strong> <br />
...
window.open('../../sendemailwithpdf.php?refid=<?php echo $ref_no; ?>','_self');
</script>
