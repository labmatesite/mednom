...
$html = '<div id="datatosave" class="datatosave"><div style="font-size:17px;"><hr><div align="center" contenteditable="true"><strong>Proforma Invoice</strong><hr></div></div><br><table><tr nobr="true"><td nobr="true"><p contenteditable="true"><strong> To,<br>'.ucwords($row_contacts['cont_sal']).' '.ucwords($row_contacts['cont_firstname']).' '.ucwords($row_contacts['cont_lastname']).'</strong><br />
...
<div style="clear:both"></div><table border="1" cellspacing="0" cellpadding="2" width="100%" contenteditable="true" nobr="true"><thead><tr nobr="true">
  ...
  </table><br><br><table border="1" width="100%" cellpadding="10" contenteditable="true"><tr nobr="true"><td nobr="true" width="70%"><p><strong><em> Terms and Conditions</em></strong><br></p>'.$row_qt1['qt_tnc'].'</td><td nobr="true" width="30%"><br><br><br><img src="images/Labocon-Stamp-and-Signatutre.png"  width="113" height="85"></td></tr></table></div>';
...
$div = $xpath->query('//div[@class="datatosave"]');
...
<input type="button" value="Generate" name="Generate" onClick="myfunction();" >
<?php
if(isset($_POST['mydata']))
{
$temp2 = $_POST['mydata'];
mysql_query("insert into testdata set data='$temp2'");
}
?>