...
function product_Price(val1, cnt,username,price) {
    ...
    $.ajax({
        ...
        data: "val1=" + val2 + "&cnt1=" + cnt + "&money=" + val5+ "&price=" + price+ "&username=" + username,
        cache: false,
...
function tnc(tnc_refid) //  updating the terms and conditions textarea
{
    var strURL = "edittnc.php?tnc_refid=" + tnc_refid;
    var req = getXMLHTTP();
