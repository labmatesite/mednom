...
//alert(cnt);
	...
	var strURL="addnewrow.php?cnt="+cnt+ "&username=" + userid;
		var req = getXMLHTTP();
												...
												<tr id="addrowid<?php echo $k ?>">
													...
													<th>
														<div class="control-group">
															...
															<div class="controls">
			<select name="product_name<?php echo $k ?>" id="product_name<?php echo $k ?>" data-rule-required="true"  onChange="product_Desc(this.value,'<?php echo $k ?>');product_Price(this.value, '1','<?php echo $udetails[0]['username']?>','<?php echo $upr;  ?>');">
