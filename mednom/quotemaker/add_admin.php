            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-bordered box-color">
                        <div class="box-title">
                            <h3><i class="icon-th-list"></i>Add Admin</h3>
                        </div>
                        <div class="box-content nopadding">
                            <form action="addadminaction.php" enctype="multipart/form-data" method="POST"
                                  class='form-horizontal form-bordered form-validate' id="bb">
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Rights <span
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="password" id="password" placeholder="Password"
                                               class="input-xlarge" data-rule-required="true" data-rule-minlength="5">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" data-rule-email="true" class="input-xlarge"
                                               placeholder="Email Address" id="emailid" name="emailid">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="tnc" id="elm1" rows="5" class="input-block-level"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label for="textfield" class="control-label">Currency<span
                                            style="color:#FF0000">*</span></label>
                                    <div class="controls">
                                        <select id="qt_cur" name="qt_cur" class="select2-me input-xsmall" required>
                                    ...
                                    <div class="controls">
                                        ...
                                        <select id="qt_price" name="qt_price" class="select2-me input-xsmall" required>
                                            ...
                                            foreach ($tabs as $key => $value) {
                                                ...
                                                ?>
                                                <option
                                                    value="<?php echo $value['Field']; ?>"><?php echo $value['Field']; ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="input-xlarge" placeholder="Host" id="host"
                                               name="host">
                                    </div>
                                </div>
                                <div class="control-group">
