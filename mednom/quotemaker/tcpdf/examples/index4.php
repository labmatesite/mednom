...
$html = '<div style="font-size:17px;"><hr><div align="center"><strong>Invoice</strong><hr></div></div><br><table><tr><td><p><strong> To,<br>'.ucwords($row_contacts['cont_sal']).' '.ucwords($row_contacts['cont_firstname']).' '.ucwords($row_contacts['cont_lastname']).'</strong><br />
